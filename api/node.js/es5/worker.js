...
function cargs(obj) {
  ...
  if ("image_path" in obj) {
    if (obj.image_path === null) throw new Error("Image path is empty.");
...
if (!worker_threads_1.isMainThread) {
  var _a = worker_threads_1.workerData,
    _b = _a.path,
    path = _b === void 0 ? __default.path : _b,
    _c = _a.args,
    args = _c === void 0 ? [] : _c,
    options = _a.options,
    debug_1 = _a.debug;
  var mode_1 = 0;
  var proc_1 = (0, child_process_1.spawn)(
    path,
    args.concat(__default.args),
    __assign(__assign({}, options), __default.options)
  );
  process.once("exit", proc_1.kill.bind(proc_1));
  proc_1.once("exit", process.exit);
  new Promise(function (res) {
    return proc_1.stdout.on("data", function stdout(chunk) {
    ...
    .then(function () {
      return new Promise(function (res) {
        ...
        proc_1.stderr.once("data", function () {
          return null;
        });
        proc_1.stdout.once("data", function (chunk) {
          ...
          process.stdout.write(
            "pid="
              .concat(proc_1.pid, ", addr=")
              .concat(socket[0], ", port=")
              .concat(socket[1], "\n")
          );
